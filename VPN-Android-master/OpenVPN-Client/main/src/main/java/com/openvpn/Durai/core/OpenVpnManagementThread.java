...
public class OpenVpnManagementThread implements Runnable, OpenVPNManagement {
    ...
    private void processProxyCMD(String argument) {
        ...
        if (proxyaddr instanceof InetSocketAddress) {
            ...
            VpnStatus.logInfo(com.openvpn.Durai.R.string.using_proxy, isa.getHostName(), isa.getPort());
    ...
    private void proccessPWFailed(String needed, String args) {
        VpnStatus.updateStateString("AUTH_FAILED", needed + args, com.openvpn.Durai.R.string.state_auth_failed, VpnStatus.ConnectionStatus.LEVEL_AUTH_FAILED);
    }
